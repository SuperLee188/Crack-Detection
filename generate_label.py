# -*- coding: utf-8 -*-
"""
Created on Sun Oct  7 19:38:54 2018
...
# train data
data_path = 'G:/tianchi_dataset/guangdong_round1_train2_20180916'
img_path, label = [], []
...
label_file.to_csv('D:/tainchi_demo/label.csv', index=False)

# test data
test_data_path = 'G:/tianchi_dataset/guangdong_round1_test_a_20180916'
...
test_file.to_csv('D:/tainchi_demo/test.csv', index=False)